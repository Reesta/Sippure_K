...
class ProductRepositoryImpl : ProductRepository{
    ...
    private val cloudinary = Cloudinary(
        mapOf(
            "cloud_name" to "dksspscov",
            "api_key" to "543658965519488",
            "api_secret" to "ERsk49Vrm-PAZcxBpxkpBb1kCyk"
        )
    )
    ...
    override fun addProduct(
        ...
        data.productId =id
        ref.child(data.productId).setValue(data).addOnCompleteListener {
            if (it.isSuccessful){
